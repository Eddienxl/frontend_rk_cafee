  ...
  Widget _buildOrderGrid(List<OrderModel> orders, {bool isHistory = false}) {
    return GridView.builder(
      ...
      gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
        crossAxisCount: 3, // 3 Columns for Tablet/Desktop, maybe too small for phone? User didn't specify device but "android". 
        // Assuming tablet/desktop or landscape for "Barista". If phone, 1 or 2 is better. 
        // Previously it was 3. I will keep 3 but adjust ratio if needed.
